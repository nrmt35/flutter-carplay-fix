...
class CPListImageRowItem extends CPListTemplateItem {
  ...
  /// Which registered artwork-placeholder slot (see
  /// [FlutterCarplay.setArtworkPlaceholder]) to show while [gridImages] load
  /// or when one fails to download. `null` uses the `'default'` slot.
