...
class CPListTemplate extends CPTemplate {
  ...
  ///
  /// Always stored as a modifiable list (see the constructor) so
  /// [updateSections] can mutate it in place — callers may pass a `const []`
  /// or otherwise unmodifiable list, which would otherwise throw on `.clear()`.
  /// iOS 12.0+ | iPadOS 12.0+ | Mac Catalyst 13.1+
  ...
  CPListTemplate({
    ...
    this.backButton,
    String? id,
  })  : sections = List<CPListSection>.from(sections),
