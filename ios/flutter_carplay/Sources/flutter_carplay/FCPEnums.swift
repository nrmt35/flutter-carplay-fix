...
enum FCPChannelTypes {
  ...
  static let onNowPlayingActiveChange = "onNowPlayingActiveChange"
  static let updateNowPlayingUpNextButton = "updateNowPlayingUpNextButton"
  static let onNowPlayingUpNextButtonPressed = "onNowPlayingUpNextButtonPressed"
  static let setArtworkPlaceholder = "setArtworkPlaceholder"
}
